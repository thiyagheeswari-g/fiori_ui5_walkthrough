...
IP.2 = fe80::1
`;
export function generateOpensslConf(commonName) {
...
export function generateRootCertificate(commonName, opensslConfPath) {
...
export function generateSignedCertificate(commonName, opensslConfPath, rootKeyPath, caPath) {
